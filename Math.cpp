 ...
 * based on the answer.
 *
 * This section displays overloading a constructor with the format being
 * inspired by this example from Geeks for Geeks:
...
auto Math::question3(float* pts) -> float
{
	...
	public:
		 ...
		 * @param float a (user defined num1)
		 * @param float b (user defined num2)
		...
		*/
		 ...
		 * @return result which equals zero
		*/
	...
	/**
	 * @brief Overloads the two solveEquation constructors and
	 * assigns points.
	*/
	auto doSolveEquation() -> void;
	{
		...
		std::cout << "\nBut what does it mean? Well, thank you for asking!"
			<< std::endl;
